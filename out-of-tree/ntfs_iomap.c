...
// TODO: implement (if needed) ntfs_map_blocks, 
// ntfs_submit_ioend, ntfs_discard_folio for
// backward compatibility with older kernels
// < 6.17

static int ntfs_map_blocks(
...
static int ntfs_submit_ioend(
	struct iomap_writepage_ctx *wpc,
	int error)
{
}

static void ntfs_discard_folio(
	struct folio *folio,
	loff_t pos)
{
}
